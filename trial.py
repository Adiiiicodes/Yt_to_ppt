...
# Example transcription (formatted for this test)
transcription = """
You have just finished gardening. Weeds can grow super fast, and they can take over the garden. What does it mean when we say 'grow like a weed'? It refers to something that grows very quickly. The term 'grow like a weed' is often used to describe rapid growth, particularly in children or plants. It is commonly used to express surprise at how quickly something has developed. In gardening, weeds grow fast and can choke the life out of your plants. The term can also be applied to other aspects, such as how quickly businesses or ideas can grow. Just like a weed, which grows fast without effort, some things in life progress quickly when the right conditions are met.
"""

# Call the function to create a visually appealing PowerPoint
create_beautiful_pptx(transcription)